                                    ...
                                    @foreach($permissions as $permission)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{url('permissions/'.$permission->id.'/edit')}}" class="btn btn-sm btn-outline-warning mx-3" >Edit</a>
                                                <a href="{{url('permissions/'.$permission->id.'/delete')}}" class="btn btn-sm btn-outline-danger" >Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
